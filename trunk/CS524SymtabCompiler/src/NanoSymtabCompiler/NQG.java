...
public class NQG //Nano Quad Generator
{
   ...
   private ArrayList globalConstQuadList;
   private ArrayList localConstQuadList;
   ...
   public NQG(int size) //For our purposes a standard safe choice is 10000
   {
      ...
      globalConstQuadList = new ArrayList();
      localConstQuadList = new ArrayList();
   }
   ...
   public void addToGlobalConstQuadList(MemModQuad mq) { globalConstQuadList.add(mq); }
   public ArrayList getGlobalConstQuadList() { return globalConstQuadList; }
   public void clearGlobalConstQuadList() { globalConstQuadList = new ArrayList(); }
   public void addToLocalConstQuadList(MemModQuad mq) { localConstQuadList.add(mq); }
   public ArrayList getLocalConstQuadList() { return localConstQuadList; }
   public void clearLocalConstQuadList() { localConstQuadList = new ArrayList(); }
   ...
   //Again notice this inheritance (NOT InstrModQuad)
   public final class Prelude extends MemModQuad 
   {
   ...
   public final class Return extends InstrModQuad 
   {
      ...
      public int getNewStackTopOffset() { return newStackTopOffset; }
      //Needs to override the parent toString to show the indirection of an address
      //containing a return index
      public String toString() { return "< I-" + quadId + "\t| " +
           getQuadTypeName() + "\t|\t"+targetQuadIndex+"@\t|\t-\t|\t" 
                                    + newStackTopOffset + "\t>"; }
   }
   ...
   public static final int OFFSET=  25;      //Used in calculating array indices
