...
/*->
  ...
  IntDeque implements a deque of integers.  We view a deque as an array which
...
public class IntDeque implements ConstIntDeque, Cloneable 
{

	// The buffer to hold the elements of the deque
    ...
    public IntDeque (int firstIndex, int elementCount, int fill, int additionalCapacity)
	{
		super();
		...
		{
			throw new IllegalArgumentException ("IntDeque.IntDeque");
		}

		// Allocate the array

		_elementData = new int[elementCount + additionalCapacity];
    ...
    public IntDeque (int firstIndex, int elementCount, int fill)
	{
	...
	public boolean compact (int additionalCapacity)
	{
		...
		{
			throw new IllegalArgumentException ("IntDeque.compact");
		}
		...
		int[] newArray = new int[_elementCount + additionalCapacity];
	...
	public boolean ensureCapacity (int additionalCapacity)
	{
		...
		if ((additionalCapacity < 0) || ((_elementCount + additionalCapacity) < 0))
		{
			throw new IllegalArgumentException ("IntDeque.ensureCapacity");
		}
	...
	private int arrayOffset (int relativeIndex)
	{
		...
		{
			throw new IndexOutOfBoundsException ("IntDeque.arrayOffset");
		}
	...
	private void circularFill (int dstOffset, int dstLength, int fill)
	{
	...
	private void removeRegion (int relIndex, int relLength)
	{
		...
		{
			throw new IndexOutOfBoundsException ("IntDeque.removeRegion");
		}
	...
	public void setFirst (int element, int index)
	{
	...
	public void setLast (int element, int index)
	{
	...
	{
		int returnValue = _elementData[arrayOffset (index)];
	...
	public int popFirst ()
	{
		int returnValue = _elementData[arrayOffset (0)];
		removeRegion (0, 1);
		++_firstIndex;
		return returnValue;
	}
	...
	public int popLast (int index)
	{
		int returnValue = _elementData[arrayOffset ((_elementCount - 1) - index)];
	...
	public int popLast ()
	{
		int returnValue = _elementData[arrayOffset (_elementCount - 1)];
	...
	public void pushFirst (int element, int index)
	{
	...
	public void pushLast (int element, int index)
	{
	...
	{
		return new IntDequeEnumerator (this, firstIndex(), 1);
    }
	...
	{
		return new IntDequeEnumerator (this, lastIndex(), -1);
    }
	...
	public int firstIndexOf (UnaryIntPredicate pred, int index)
	{
		...
		if (index < 0)
		{
			throw new IndexOutOfBoundsException ("IntDeque.firstIndexOf");
		}
	...
	public int lastIndexOf (UnaryIntPredicate pred, int index)
	{
		...
		if (index < 0)
		{
			throw new IndexOutOfBoundsException ("IntDeque.lastIndexOf");
		}
	...
	public void setRange (int newFirstIndex, int newElementCount, int fill)
	{
		...
		{
			throw new IllegalArgumentException ("IntDeque.setRange");
		}
    ...
    public Object clone ()
	{
		try
		{
			...
			IntDeque cloneDeque = (IntDeque) super.clone();

			// Clone the data array

			cloneDeque._elementData = (int[]) this._elementData.clone();
	...
	public String toString ()
	{
		...
		while (e.hasMoreElements ())
		{
			...
			buf.append (Integer.toString (e.nextElement ()));
		}
...
final class IntDequeEnumerator implements IntEnumeration
{

	// The deque we are enumerating

	private IntDeque _deque;
	...
	IntDequeEnumerator (IntDeque deque, int index, int increment)
	{
	...
	public int nextElement ()
	{
		...
		try
		{
			...
			int returnValue = _deque.elementAt(_index);
		...
		{
			throw new NoSuchElementException ("IntDequeEnumerator.nextElement");
		}
	}
